 ...
 * @author TSA10
 */
public class main_stock_login extends javax.swing.JFrame {

    /**
     * Creates new form main_stock_login
     */
    public main_stock_login() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(main_stock_login.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new main_stock_login().setVisible(true);
            }
        });
    }
